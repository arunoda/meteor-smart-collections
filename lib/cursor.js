...
Cursor.prototype.__publishCursor = function(subscription, callback) {
  var self = this;
  var socketSession = subscription._session.socket.meteor_session;
  if(!socketSession._sessionView) {
    socketSession._sessionView = new Meteor.SmartSessionView(socketSession, self._collection.name);
  }

  this._observeChanges({
    added: function(id, doc) {
      socketSession._sessionView.added(id, doc);
    },
    changed: function(id, fields) {
      socketSession._sessionView.changed(id, fields);
    },
    removed: function(id) {
      socketSession._sessionView.removed(id);
    }
