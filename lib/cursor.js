...
Cursor.prototype.__publishCursor = function(subscription, callback) {
  ...
  this._observeChanges({
    added: function(id, doc) {
      socketSession.sendAdded(self._collection.name, id, doc);
    },
    changed: function(id, fields) {
      socketSession.sendChanged(self._collection.name, id, fields);
    },
    removed: function(id) {
      socketSession.sendRemoved(self._collection.name, id);
    }
