function SmartCollection(name, options) {
  var self = this;
  this.name = name;
  this._remoteCollection = new Meteor.Collection(name);
  this._localCollection = new Meteor.Collection(null, options);
...
SmartCollection.prototype._isSimulation = function() {
  var enclosing = (Meteor._CurrentInvocation)? Meteor._CurrentInvocation.get() : DDP._CurrentInvocation.get();
